...
- Optional local-only **Jarvis** Hyprland assistant at `/jarvis/`. It turns a natural-language desktop request into a validated plan; select **apply changes** only after reviewing the actions.
